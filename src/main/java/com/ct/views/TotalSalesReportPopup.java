...
//            java.util.logging.Logger.getLogger(TotalSalesReportPopup.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                TotalSalesReportPopup dialog = new TotalSalesReportPopup(new javax.swing.JFrame(), true);
